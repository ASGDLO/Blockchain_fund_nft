...
var Annotation = /** @class */ (function (_super) {
    ...
    Annotation.prototype.arc = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'arc' }, option));
        return this;
    };
    /**
     * 创建 image
    ...
    Annotation.prototype.image = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'image' }, option));
        return this;
    };
    /**
     * 创建 Line
    ...
    Annotation.prototype.line = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'line' }, option));
        return this;
    };
    /**
     * 创建 Region
    ...
    Annotation.prototype.region = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'region' }, option));
        return this;
    };
    /**
     * 创建 Text
    ...
    Annotation.prototype.text = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'text' }, option));
        return this;
    };
    /**
     * 创建 DataMarker
    ...
    Annotation.prototype.dataMarker = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'dataMarker' }, option));
        return this;
    };
    /**
     * 创建 DataRegion
    ...
    Annotation.prototype.dataRegion = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'dataRegion' }, option));
    };
    /**
     * 创建 RegionFilter
     * @param option
    ...
    Annotation.prototype.regionFilter = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'regionFilter' }, option));
    };
    /**
     * 创建 ShapeAnnotation
     * @param option
    ...
    Annotation.prototype.shape = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'shape' }, option));
    };
    /**
     * 创建 HtmlAnnotation
     * @param option
    ...
    Annotation.prototype.html = function (option) {
        this.annotation((0, tslib_1.__assign)({ type: 'html' }, option));
    };
    // end API
    /**
    ...
    Annotation.prototype.getAnnotationCfg = function (type, option, theme) {
        ...
        if (type === 'arc') {
            var _a = option, start = _a.start, end = _a.end, rest = (0, tslib_1.__rest)(_a, ["start", "end"]);
            ...
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { center: coordinate.getCenter(), radius: (0, coordinate_1.getDistanceToCenter)(coordinate, sp), startAngle: startAngle, endAngle: endAngle });
        }
        else if (type === 'image') {
            var _b = option, start = _b.start, end = _b.end, rest = (0, tslib_1.__rest)(_b, ["start", "end"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { start: this.parsePosition(start), end: this.parsePosition(end), src: option.src });
        }
        else if (type === 'line') {
            var _c = option, start = _c.start, end = _c.end, rest = (0, tslib_1.__rest)(_c, ["start", "end"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { start: this.parsePosition(start), end: this.parsePosition(end), text: (0, util_1.get)(option, 'text', null) });
        }
        else if (type === 'region') {
            var _d = option, start = _d.start, end = _d.end, rest = (0, tslib_1.__rest)(_d, ["start", "end"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { start: this.parsePosition(start), end: this.parsePosition(end) });
        }
        else if (type === 'text') {
            var filteredData = this.view.getData();
            var _e = option, position = _e.position, content = _e.content, rest = (0, tslib_1.__rest)(_e, ["position", "content"]);
            var textContent = content;
            if ((0, util_1.isFunction)(content)) {
                textContent = content(filteredData);
            }
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.parsePosition(position)), rest), { content: textContent });
        }
        else if (type === 'dataMarker') {
            var _f = option, position = _f.position, point = _f.point, line = _f.line, text = _f.text, autoAdjust = _f.autoAdjust, direction = _f.direction, rest = (0, tslib_1.__rest)(_f, ["position", "point", "line", "text", "autoAdjust", "direction"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), this.parsePosition(position)), { coordinateBBox: this.getCoordinateBBox(), point: point, line: line, text: text, autoAdjust: autoAdjust, direction: direction });
        }
        else if (type === 'dataRegion') {
            var _g = option, start = _g.start, end = _g.end, region = _g.region, text = _g.text, lineLength = _g.lineLength, rest = (0, tslib_1.__rest)(_g, ["start", "end", "region", "text", "lineLength"]);
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { points: this.getRegionPoints(start, end), region: region, text: text, lineLength: lineLength });
        }
        else if (type === 'regionFilter') {
            var _h = option, start = _h.start, end = _h.end, apply_1 = _h.apply, color = _h.color, rest = (0, tslib_1.__rest)(_h, ["start", "end", "apply", "color"]);
            ...
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rest), { color: color, shapes: shapes_1, start: this.parsePosition(start), end: this.parsePosition(end) });
        }
        else if (type === 'shape') {
            var _j = option, render_1 = _j.render, restOptions = (0, tslib_1.__rest)(_j, ["render"]);
            ...
            o = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, restOptions), { render: wrappedRender });
        }
        else if (type === 'html') {
            var _k = option, html_1 = _k.html, position = _k.position, restOptions = (0, tslib_1.__rest)(_k, ["html", "position"]);
        ...
        // 合并主题，用户配置优先级高于默认主题
        var cfg = (0, util_1.deepMix)({}, theme, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, o), { top: option.top, style: option.style, offsetX: option.offsetX, offsetY: option.offsetY }));
        if (type !== 'html') {
