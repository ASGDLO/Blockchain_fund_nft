...
var Legend = /** @class */ (function (_super) {
    ...
    Legend.prototype.layout = function () {
        ...
        (0, util_1.each)(this.components, function (co) {
            ...
            var _a = (0, direction_1.directionToPosition)(_this.view.viewBBox, bbox, direction), x1 = _a[0], y1 = _a[1];
            var _b = (0, direction_1.directionToPosition)(_this.layoutBBox, bbox, direction), x2 = _b[0], y2 = _b[1];
            var x = 0;
            var y = 0;
