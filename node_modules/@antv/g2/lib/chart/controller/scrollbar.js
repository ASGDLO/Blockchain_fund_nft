...
var Scrollbar = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(Scrollbar, _super);
    ...
    Scrollbar.prototype.layout = function () {
        ...
        if (this.scrollbar) {
            ...
            var y = void 0;
            if (cfg.isHorizontal) {
                var _a = (0, direction_1.directionToPosition)(this.view.viewBBox, bbox, constant_1.DIRECTION.BOTTOM), x1 = _a[0], y1 = _a[1];
                var _b = (0, direction_1.directionToPosition)(this.view.coordinateBBox, bbox, constant_1.DIRECTION.BOTTOM), x2 = _b[0], y2 = _b[1];
                x = x2;
                y = y1;
            }
            else {
                var _c = (0, direction_1.directionToPosition)(this.view.viewBBox, bbox, constant_1.DIRECTION.RIGHT), x1 = _c[0], y1 = _c[1];
                var _d = (0, direction_1.directionToPosition)(this.view.viewBBox, bbox, constant_1.DIRECTION.RIGHT), x2 = _d[0], y2 = _d[1];
                x = x2;
                y = y1;
            }
            x += padding[3];
            ...
            // 默认放在 bottom
            if (this.trackLen) {
                this.scrollbar.component.update((0, tslib_1.__assign)((0, tslib_1.__assign)({}, cfg), { x: x, y: y, trackLen: this.trackLen, thumbLen: this.thumbLen, thumbOffset: (this.trackLen - this.thumbLen) * this.ratio }));
            }
            else {
                this.scrollbar.component.update((0, tslib_1.__assign)((0, tslib_1.__assign)({}, cfg), { x: x, y: y }));
            }
    ...
    Scrollbar.prototype.getScrollbarTheme = function (style) {
        ...
        var _a = style || {}, thumbHighlightColor = _a.thumbHighlightColor, restStyles = (0, tslib_1.__rest)(_a, ["thumbHighlightColor"]);
        return {
    ...
    Scrollbar.prototype.createScrollbar = function () {
        var type = this.getValidScrollbarCfg().type;
        var isHorizontal = type !== 'vertical';
        var component = new dependents_1.Scrollbar((0, tslib_1.__assign)((0, tslib_1.__assign)({ container: this.container }, this.getScrollbarComponentCfg()), { x: 0, y: 0 }));
        component.init();
        return {
            component: component,
    ...
    Scrollbar.prototype.updateScrollbar = function () {
        ...
        var realConfig = this.trackLen
            ? (0, tslib_1.__assign)((0, tslib_1.__assign)({}, config), { trackLen: this.trackLen, thumbLen: this.thumbLen, thumbOffset: (this.trackLen - this.thumbLen) * this.ratio }) : (0, tslib_1.__assign)({}, config);
    ...
    Scrollbar.prototype.getScrollbarComponentCfg = function () {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.getThemeOptions()), { x: position.x, y: position.y, size: isHorizontal ? height : width, isHorizontal: isHorizontal, trackLen: trackLen, thumbLen: thumbLen, thumbOffset: 0, theme: this.getScrollbarTheme(style) });
    };
    /**
     * 填充一些默认的配置项目
     */
    Scrollbar.prototype.getValidScrollbarCfg = function () {
        ...
        if ((0, util_1.isObject)(this.option)) {
            cfg = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, cfg), this.option);
        }
    ...
    Scrollbar.prototype.getScrollbarData = function () {
        ...
        if (coordinate.isReflect('y') && cfg.type === 'vertical') {
            data = (0, tslib_1.__spreadArray)([], data, true).reverse();
        }
        return data;
    };
    return Scrollbar;
