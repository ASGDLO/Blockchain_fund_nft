...
var Slider = /** @class */ (function (_super) {
    ...
    Slider.prototype.layout = function () {
        ...
        if (this.slider) {
            ...
            var _b = (0, direction_1.directionToPosition)(this.view.viewBBox, bbox, constant_1.DIRECTION.BOTTOM), x1 = _b[0], y1 = _b[1];
            var _c = (0, direction_1.directionToPosition)(this.view.coordinateBBox, bbox, constant_1.DIRECTION.BOTTOM), x2 = _c[0], y2 = _c[1];
            // 默认放在 bottom
            this.slider.component.update((0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.getSliderCfg()), { x: x2 + paddingLeft, y: y1 + paddingTop, width: this.width, start: this.start, end: this.end, minText: minText, maxText: maxText }));
    ...
    Slider.prototype.createSlider = function () {
        ...
        // 添加 slider 组件
        var component = new dependents_1.Slider((0, tslib_1.__assign)({ container: this.container }, cfg));
        component.init();
        return {
            component: component,
    ...
    Slider.prototype.updateSlider = function () {
        ...
        if (this.width) {
            var _a = this.getMinMaxText(this.start, this.end), minText = _a.minText, maxText = _a.maxText;
            cfg = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, cfg), { width: this.width, start: this.start, end: this.end, minText: minText, maxText: maxText });
        }
    ...
    Slider.prototype.getSliderCfg = function () {
        ...
        if ((0, util_1.isObject)(this.option)) {
            // 用户配置的数据，优先级更高
            var trendCfg = (0, tslib_1.__assign)({ data: this.getData() }, (0, util_1.get)(this.option, 'trendCfg', {}));
            // 因为有样式，所以深层覆盖
            cfg = (0, util_1.deepMix)({}, cfg, this.getThemeOptions(), this.option);
            // trendCfg 因为有数据数组，所以使用浅替换
            cfg = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, cfg), { trendCfg: trendCfg });
        }
