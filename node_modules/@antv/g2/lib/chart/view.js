...
var coordinate_2 = (0, tslib_1.__importDefault)(require("./controller/coordinate"));
...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.facet = function (type, cfg) {
        ...
        this.facetInstance = new Ctor(this, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, cfg), { type: type }));
        return this;
    };
    /*
     * 开启或者关闭动画。
    ...
    View.prototype.adjustCategoryScaleRange = function () {
        var _this = this;
        var xyScales = (0, tslib_1.__spreadArray)([this.getXScale()], this.getYScales(), true).filter(function (e) { return !!e; });
        var coordinate = this.getCoordinate();
    ...
    View.prototype.initOptions = function () {
        ...
        if (facets) {
            (0, util_1.each)(facets, function (facet) {
                var type = facet.type, rest = (0, tslib_1.__rest)(facet, ["type"]);
