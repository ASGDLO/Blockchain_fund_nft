...
var Labels = /** @class */ (function () {
    ...
    Labels.prototype.renderLabel = function (cfg, container) {
        ...
        var shapeAppendCfg = {
            ...
            elementId: elementId,
            data: data,
            origin: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, mappingData), { data: mappingData[constant_1.FIELD_ORIGIN] }),
            coordinate: coordinate,
        };
        var labelGroup = container.addGroup((0, tslib_1.__assign)({ name: 'label', 
        ...
        if ((content.isGroup && content.isGroup()) || (content.isShape && content.isShape())) {
            ...
            labelShape = labelGroup.addShape('text', (0, tslib_1.__assign)({ attrs: (0, tslib_1.__assign)((0, tslib_1.__assign)({ x: cfg.x, y: cfg.y, textAlign: cfg.textAlign, textBaseline: (0, util_1.get)(cfg, 'textBaseline', 'middle'), text: cfg.content }, cfg.style), { fill: (0, util_1.isNull)(fill) ? cfg.color : fill }) }, shapeAppendCfg));
        }
        if (cfg.rotate) {
    ...
    Labels.prototype.doLayout = function (items, shapes) {
        var _this = this;
        if (this.layout) {
            var layouts = (0, util_1.isArray)(this.layout) ? this.layout : [this.layout];
            (0, util_1.each)(layouts, function (layout) {
                var layoutFn = (0, label_1.getGeometryLabelLayout)((0, util_1.get)(layout, 'type', ''));
                if (layoutFn) {
                    var labelShapes_1 = [];
                    var geometryShapes_1 = [];
                    (0, util_1.each)(_this.shapesMap, function (labelShape, id) {
        ...
        (0, util_1.each)(labelItems, function (labelItem) {
            ...
            if (!labelGroup.destroyed) {
                labelGroup.addShape('path', {
                    capture: false,
                    attrs: (0, tslib_1.__assign)({ path: path, stroke: labelItem.color ? labelItem.color : (0, util_1.get)(labelItem, ['style', 'fill'], '#000'), fill: null }, labelLineCfg.style),
                    id: id,
        ...
        (0, util_1.each)(labelItems, function (labelItem) {
            ...
            if (!labelGroup.destroyed) {
                ...
                if (labelContentShape) {
                    var _a = (0, util_2.getlLabelBackgroundInfo)(labelGroup, labelItem, background.padding), rotation = _a.rotation, box = (0, tslib_1.__rest)(_a, ["rotation"]);
                    var backgroundShape = labelGroup.addShape('rect', {
                        attrs: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, box), (background.style || {})),
                        id: id,
                        origin: labelItem.mappingData,
                        data: labelItem.data,
                        coordinate: labelItem.coordinate,
