...
var element_1 = (0, tslib_1.__importDefault)(require("./element"));
...
var Geometry = /** @class */ (function (_super) {
    ...
    Geometry.prototype.updateElements = function (mappingDataArray, isUpdate) {
        ...
        var _a = (0, diff_1.diff)(this.lastElementsMap, keys), added = _a.added, updated = _a.updated, removed = _a.removed;
        // 新建 element
    ...
    Geometry.prototype.adjustData = function (dataArray) {
        ...
        if (adjustOption) {
            ...
            for (var i = 0, len = adjustOption.length; i < len; i++) {
                ...
                var adjustCfg = (0, tslib_1.__assign)({ xField: xField, yField: yField, intervalPadding: intervalPadding, dodgePadding: dodgePadding, xDimensionLength: xDimensionLength, groupNum: groupNum, defaultSize: defaultSize, maxColumnWidth: maxColumnWidth, minColumnWidth: minColumnWidth, columnWidthRatio: columnWidthRatio }, adjust);
