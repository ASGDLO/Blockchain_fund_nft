...
var LinkByColor = /** @class */ (function (_super) {
    ...
    LinkByColor.prototype.addLinkShape = function (group, element, nextElement, activeStyle) {
        ...
        group.addShape({
            type: 'path',
            attrs: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (0, util_2.deepMix)({}, style, (0, util_2.isFunction)(activeStyle) ? activeStyle(style, element) : activeStyle)), { path: this.getLinkPath(element, nextElement) }),
        });
    };
    // 使用图形连接
