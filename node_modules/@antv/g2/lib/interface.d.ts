 ...
 * WAI-ARIA 无障碍标签配置
 */
export declare type AriaOption = false | {
...
export declare type RectData = FacetData;
/** mirror 分面类型配置 */
...
export declare type MirrorData = FacetData;
/** list 分面类型配置 */
...
export declare type MatrixData = FacetData;
/** circle 分面类型配置 */
export interface CircleCfg extends FacetCfg<CircleData> {
    /** 分面标题配置。 */
    readonly title?: FacetTitle;
}
export declare type CircleData = FacetData;
