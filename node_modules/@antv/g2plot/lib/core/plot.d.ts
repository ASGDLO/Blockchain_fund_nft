...
import { Options, StateName, StateCondition, StateObject, Annotation } from '../types';
import { Adaptor } from './adaptor';
/** 单独 pick 出来的用于基类的类型定义 */
export declare type PickOptions = Pick<Options, 'width' | 'height' | 'padding' | 'appendPadding' | 'renderer' | 'pixelRatio' | 'autoFit' | 'syncViewPadding' | 'supportCSSTransform' | 'limitInPlot' | 'locale' | 'defaultInteractions'>;
/** plot 图表容器的配置 */
