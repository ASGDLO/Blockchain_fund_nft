...
describe('addressHelper', function () {
    describe('shortenAddress', function () {
        it('correct address', function () {
            ...
            (0, chai_1.expect)((0, address_1.shortenAddress)(address)).to.eq('0x6E9e...D3A0');
        });
        ...
        it('not checksummed address', function () {
            ...
            (0, chai_1.expect)((0, address_1.shortenAddress)(address)).to.eq('0x0C34...2668');
        });
        it('wrong address', function () {
            var address = "i'm not an address";
            (0, chai_1.expect)(function () { return (0, address_1.shortenAddress)(address); }).to["throw"]("Invalid input, address can't be parsed");
        });
    });
    describe('shortenIfAddress', function () {
        it('correct address', function () {
            var address = '0x6E9e7A8Fb61b0e1Bc3cB30e6c8E335046267D3A0';
            (0, chai_1.expect)((0, address_1.shortenIfAddress)(address)).to.eq('0x6E9e...D3A0');
        });
        it('wrong address', function () {
            var address = "i'm not an address";
            (0, chai_1.expect)(function () { return (0, address_1.shortenAddress)(address); }).to["throw"]("Invalid input, address can't be parsed");
        ...
        testCases.forEach(function (_a) {
            ...
            it(description, function () {
                (0, chai_1.expect)((0, address_1.shortenIfAddress)(value)).to.eq('');
            });
        });
    });
    describe('addressCompare', function () {
        it('first bigger', function () {
            ...
            (0, chai_1.expect)((0, address_1.compareAddress)(address1, address2)).to.eq(1);
        });
        ...
        it('both equal', function () {
            ...
            (0, chai_1.expect)((0, address_1.compareAddress)(address1, address2)).to.eq(0);
        });
        it("can't parse address", function () {
            var address1 = 'im not an address';
            var address2 = '0xb293c3b2b4596824c57ad642ea2da4e146cca4cf';
            (0, chai_1.expect)(function () { return (0, address_1.compareAddress)(address1, address2); }).to["throw"]("Invalid input, address can't be parsed");
        });
    });
    describe('addressEqual', function () {
        it('equal without prefix', function () {
            var address1 = '0x263b2f09cc8754351b6ba9926a7e73ff2302d81f';
            var address2 = '263b2f09cc8754351b6ba9926a7e73ff2302d81f';
            (0, chai_1.expect)((0, address_1.addressEqual)(address1, address2)).to.eq(true);
        });
        it('equal with different case', function () {
            var address1 = '0x263b2f09cc8754351b6ba9926a7e73ff2302d81f';
            var address2 = '0x263b2f09Cc8754351B6bA9926a7e73FF2302D81f';
            (0, chai_1.expect)((0, address_1.addressEqual)(address1, address2)).to.eq(true);
        });
        it('not equal', function () {
            var address1 = '0x3e9b6812364bab40745a7ddef6a1a7a103d81c74';
            var address2 = '0xd1bbe67b8a28985f9a790bd2f13ebb42f0fc679c';
            (0, chai_1.expect)((0, address_1.addressEqual)(address1, address2)).to.eq(false);
        });
        it('not an address', function () {
            var address1 = 'im not an address';
            var address2 = '0x2690a21899aaecea9fa832972677128ff8983dd8';
            (0, chai_1.expect)(function () { return (0, address_1.addressEqual)(address1, address2); }).to["throw"]("Invalid input, address can't be parsed");
        });
    });
});
