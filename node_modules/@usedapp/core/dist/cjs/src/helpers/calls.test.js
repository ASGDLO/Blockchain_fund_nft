...
describe('decodeCallResult', function () {
    ...
    it('call error', function () {
        ...
        var _a = (0, calls_1.decodeCallResult)(call, errorResult) || {}, value = _a.value, error = _a.error;
    ...
    it('decoding error', function () {
        ...
        var _a = (0, calls_1.decodeCallResult)(call, result) || {}, value = _a.value, error = _a.error;
        (0, chai_1.expect)(value).to.be.undefined;
