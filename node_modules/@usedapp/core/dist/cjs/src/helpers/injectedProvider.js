...
function getInjectedProvider(getPollingInterval) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var injectedProviders, injectedProvider, _b, provider, chainId;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    })) !== null && _a !== void 0)) return [3 /*break*/, 1];
                    _b = _a;
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, (0, detect_provider_1["default"])()];
                case 2:
                    _b = (_c.sent());
                    _c.label = 3;
                case 3:
                    ...
                    provider = new ethers_1.providers.Web3Provider(injectedProvider, 'any');
                    return [4 /*yield*/, provider.send('eth_chainId', [])];
                case 4:
                    chainId = _c.sent();
