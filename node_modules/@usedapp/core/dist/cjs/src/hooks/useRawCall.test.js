    ...
    it('Works for a different combinations of address casing', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 1:
                    _a = _l.sent(), result = _a.result, waitForCurrent = _a.waitForCurrent;
                ...
                case 2:
                    ...
                    (0, chai_1.expect)((_c = result.current[0]) === null || _c === void 0 ? void 0 : _c.success).to.be["true"];
                    (0, chai_1.expect)((_d = result.current[0]) === null || _d === void 0 ? void 0 : _d.value).to.eq(testing_1.MOCK_TOKEN_INITIAL_BALANCE);
                    (0, chai_1.expect)((_e = result.current[1]) === null || _e === void 0 ? void 0 : _e.success).to.be["true"];
                    (0, chai_1.expect)((_f = result.current[1]) === null || _f === void 0 ? void 0 : _f.value).to.eq(testing_1.MOCK_TOKEN_INITIAL_BALANCE);
                    (0, chai_1.expect)((_g = result.current[2]) === null || _g === void 0 ? void 0 : _g.success).to.be["true"];
                    (0, chai_1.expect)((_h = result.current[2]) === null || _h === void 0 ? void 0 : _h.value).to.eq(testing_1.MOCK_TOKEN_INITIAL_BALANCE);
                    (0, chai_1.expect)((_j = result.current[3]) === null || _j === void 0 ? void 0 : _j.success).to.be["true"];
                    (0, chai_1.expect)((_k = result.current[3]) === null || _k === void 0 ? void 0 : _k.value).to.eq(testing_1.MOCK_TOKEN_INITIAL_BALANCE);
                    return [2 /*return*/];
            }
        });
    }); });
