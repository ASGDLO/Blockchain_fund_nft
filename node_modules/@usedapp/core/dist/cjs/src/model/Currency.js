...
var Currency = /** @class */ (function () {
    ...
    Currency.prototype.format = function (value, overrideOptions) {
        ...
        return (0, formatting_1.formatCurrency)(__assign(__assign({}, this.formattingOptions), overrideOptions), value);
    };
    return Currency;
}());
...
var NativeCurrency = /** @class */ (function (_super) {
    ...
    function NativeCurrency(name, ticker, chainId, decimals, formattingOptions) {
        ...
        if (formattingOptions === void 0) { formattingOptions = {}; }
        var _this = _super.call(this, name, ticker, decimals, __assign({ suffix: " ".concat(ticker), significantDigits: 6 }, formattingOptions)) || this;
