...
describe('Moonriver Chain', function () {
    ...
    it('getExplorerAddressLink', function () {
        (0, chai_1.expect)(src_1.Moonriver.getExplorerAddressLink(test_defaults_1.TEST_ADDRESS)).to.eq("https://blockscout.moonriver.moonbeam.network/address/".concat(test_defaults_1.TEST_ADDRESS, "/transactions"));
        (0, chai_1.expect)(src_1.MoonbaseAlpha.getExplorerAddressLink(test_defaults_1.TEST_ADDRESS)).to.eq("https://moonbase.moonscan.io/address/".concat(test_defaults_1.TEST_ADDRESS));
    });
    it('getExplorerTransactionLink', function () {
        (0, chai_1.expect)(src_1.Moonriver.getExplorerTransactionLink(test_defaults_1.TEST_TX)).to.eq("https://blockscout.moonriver.moonbeam.network/tx/".concat(test_defaults_1.TEST_TX, "/internal-transactions"));
        (0, chai_1.expect)(src_1.MoonbaseAlpha.getExplorerTransactionLink(test_defaults_1.TEST_TX)).to.eq("https://moonbase.moonscan.io/tx/".concat(test_defaults_1.TEST_TX));
    });
});
