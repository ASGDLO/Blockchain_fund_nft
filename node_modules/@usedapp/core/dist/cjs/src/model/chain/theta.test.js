...
describe('Theta Chain', function () {
    ...
    it('getExplorerAddressLink', function () {
        (0, chai_1.expect)(src_1.Theta.getExplorerAddressLink(test_defaults_1.TEST_ADDRESS)).to.eq("https://explorer.thetatoken.org/address/".concat(test_defaults_1.TEST_ADDRESS));
        (0, chai_1.expect)(src_1.ThetaTestnet.getExplorerAddressLink(test_defaults_1.TEST_ADDRESS)).to.eq("https://testnet-explorer.thetatoken.org/address/".concat(test_defaults_1.TEST_ADDRESS));
    });
    it('getExplorerTransactionLink', function () {
        (0, chai_1.expect)(src_1.Theta.getExplorerTransactionLink(test_defaults_1.TEST_TX)).to.eq("https://explorer.thetatoken.org/tx/".concat(test_defaults_1.TEST_TX));
        (0, chai_1.expect)(src_1.ThetaTestnet.getExplorerTransactionLink(test_defaults_1.TEST_TX)).to.eq("https://testnet-explorer.thetatoken.org/tx/".concat(test_defaults_1.TEST_TX));
    });
});
