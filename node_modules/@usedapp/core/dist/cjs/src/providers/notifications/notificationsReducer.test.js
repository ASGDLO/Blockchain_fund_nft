...
describe('notificationReducer', function () {
    it('addNotification', function () {
        ...
        (0, chai_1.expect)((0, reducer_1.notificationReducer)({}, { chainId: 1, type: 'ADD_NOTIFICATION', notification: notification })).to.deep.equal({
            1: [notification]
        });
    });
    it('notifications added in correct order', function () {
        ...
        var newState = (0, reducer_1.notificationReducer)({
            1: [initial]
        }, {
