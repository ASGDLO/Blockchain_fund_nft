...
describe('transactionsReducer', function () {
    ...
    it('correct order', function () {
        ...
        var newState = (0, reducer_1.transactionReducer)({ 1: [initial] }, { type: 'ADD_TRANSACTION', payload: added });
    ...
    it('update transactions', function () {
        ...
        var newState = (0, reducer_1.transactionReducer)({ 1: initialTransactions }, { type: 'UPDATE_TRANSACTIONS', chainId: 1, transactions: newTransactions });
