...
var createMockProvider = function (opts) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var chainId, provider, multicallAddresses;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    chainId = (_a = opts.chainId) !== null && _a !== void 0 ? _a : constants_1.ChainId.Mainnet;
                    provider = new ethereum_waffle_1.MockProvider({ ganacheOptions: { _chainIdRpc: chainId } });
                    return [4 /*yield*/, (0, deployMulticall_1.deployMulticall)(provider, chainId)];
                case 1:
                    multicallAddresses = _b.sent();
                    return [2 /*return*/, {
                            provider: provider,
