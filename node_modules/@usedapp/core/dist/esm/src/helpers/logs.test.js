...
import { decodeLogs, encodeFilterData } from './logs';
...
describe('encodeFilterData', () => {
    ...
    it('Returns FilterByBlockHash when blockHash, toBlock, and fromBlock are valid', () => {
        ...
        const encodedFilterData = encodeFilterData(filter, 0, 'latest', '0x0');
        expect(encodedFilterData['blockHash']).to.not.be.undefined;
    });
    it('Returns Filter when toBlock and fromBlock are valid but blockHash is invalid', () => {
        ...
        const encodedFilterData = encodeFilterData(filter, 0, 'latest', undefined);
...
describe('decodeLogs', () => {
    ...
    it('Returns an error if passed an error as the result', () => {
        ...
        expect(decodedLogs === null || decodedLogs === void 0 ? void 0 : decodedLogs.error).to.equal(error);
        expect(decodedLogs === null || decodedLogs === void 0 ? void 0 : decodedLogs.value).to.be.undefined;
    });
    it('Returns an empty array when passed an empty array of logs', () => {
        ...
        expect(decodedLogs === null || decodedLogs === void 0 ? void 0 : decodedLogs.error).to.be.undefined;
        expect(decodedLogs === null || decodedLogs === void 0 ? void 0 : decodedLogs.value).to.be.empty;
    });
    it('Returns an error when the event topic is a mismatch', () => {
        ...
        const decodedLogs = decodeLogs(filter, logs);
        expect(decodedLogs === null || decodedLogs === void 0 ? void 0 : decodedLogs.value).to.be.undefined;
        expect(decodedLogs === null || decodedLogs === void 0 ? void 0 : decodedLogs.error).to.be.a('Error');
    });
    it('Works when passed valid logs', () => {
        ...
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value).to.have.length(2);
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value[0].blockHash).to.equal(blockHash);
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value[0].blockNumber).to.equal(blockNumber);
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value[0].removed).to.equal(removed);
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value[0].transactionIndex).to.equal(transactionIndex);
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value[0].transactionHash).to.equal(transactionHash);
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value[0].data.from).to.equal(from);
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value[0].data.to).to.equal(to);
        expect(theLogs === null || theLogs === void 0 ? void 0 : theLogs.value[0].data.value).to.equal(value);
    });
});
