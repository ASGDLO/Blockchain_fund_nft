...
describe('Andromeda Chain', () => {
    ...
    it('getExplorerAddressLink', () => {
        expect(Andromeda.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://andromeda-explorer.metis.io/address/${TEST_ADDRESS}`);
        expect(Stardust.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://stardust-explorer.metis.io/address/${TEST_ADDRESS}`);
    });
