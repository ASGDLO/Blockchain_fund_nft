...
describe('Moonriver Chain', () => {
    ...
    it('getExplorerAddressLink', () => {
        expect(Moonriver.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://blockscout.moonriver.moonbeam.network/address/${TEST_ADDRESS}/transactions`);
        expect(MoonbaseAlpha.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://moonbase.moonscan.io/address/${TEST_ADDRESS}`);
    });
    it('getExplorerTransactionLink', () => {
        expect(Moonriver.getExplorerTransactionLink(TEST_TX)).to.eq(`https://blockscout.moonriver.moonbeam.network/tx/${TEST_TX}/internal-transactions`);
