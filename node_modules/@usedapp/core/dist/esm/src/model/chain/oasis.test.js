...
describe('Oasis Emerald Chain', () => {
    ...
    it('getExplorerAddressLink', () => {
        ...
        expect(OasisEmeraldTestnet.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://testnet.explorer.emerald.oasis.dev/address/${TEST_ADDRESS}/transactions`);
    });
    it('getExplorerTransactionLink', () => {
        ...
        expect(OasisEmeraldTestnet.getExplorerTransactionLink(TEST_TX)).to.eq(`https://testnet.explorer.emerald.oasis.dev/tx/${TEST_TX}/internal-transactions`);
    });
});
