...
describe('Theta Chain', () => {
    ...
    it('getExplorerAddressLink', () => {
        ...
        expect(ThetaTestnet.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://testnet-explorer.thetatoken.org/address/${TEST_ADDRESS}`);
    });
    it('getExplorerTransactionLink', () => {
        expect(Theta.getExplorerTransactionLink(TEST_TX)).to.eq(`https://explorer.thetatoken.org/tx/${TEST_TX}`);
        expect(ThetaTestnet.getExplorerTransactionLink(TEST_TX)).to.eq(`https://testnet-explorer.thetatoken.org/tx/${TEST_TX}`);
    });
});
