...
describe('ThunderCore Chain', () => {
    ...
    it('getExplorerAddressLink', () => {
        expect(ThunderCore.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://viewblock.io/thundercore/address/${TEST_ADDRESS}`);
        expect(ThunderCoreTestnet.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://explorer-testnet.thundercore.com/address/${TEST_ADDRESS}`);
    });
    it('getExplorerTransactionLink', () => {
        expect(ThunderCore.getExplorerTransactionLink(TEST_TX)).to.eq(`https://viewblock.io/thundercore/tx/${TEST_TX}`);
        expect(ThunderCoreTestnet.getExplorerTransactionLink(TEST_TX)).to.eq(`https://explorer-testnet.thundercore.com/tx/${TEST_TX}`);
    });
});
