...
describe('Velas Chain', () => {
    ...
    it('getExplorerAddressLink', () => {
        ...
        expect(VelasTestnet.getExplorerAddressLink(TEST_ADDRESS)).to.eq(`https://evmexplorer.testnet.velas.com/address/${TEST_ADDRESS}`);
    });
    it('getExplorerTransactionLink', () => {
        expect(Velas.getExplorerTransactionLink(TEST_TX)).to.eq(`https://evmexplorer.velas.com/tx/${TEST_TX}`);
        expect(VelasTestnet.getExplorerTransactionLink(TEST_TX)).to.eq(`https://evmexplorer.testnet.velas.com/tx/${TEST_TX}`);
    });
});
