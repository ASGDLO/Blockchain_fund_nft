...
;
exports.default = createPlot_1.default(bar_1.Bar, 'PercentStackedBarChart', function (props) {
    warning_1.default(false, '<PercentStackedBarChart /> 即将在5.0后废弃，请使用<BarChart />替代。');
