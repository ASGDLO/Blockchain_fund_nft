...
export { Annotation };
export declare type LineAxis = typeof Axis.Line;
export declare type CircleAxis = typeof Axis.Circle;
export declare type LineGrid = typeof Grid.Line;
export declare type CircleGrid = typeof Grid.Circle;
declare type CategoryLegend = typeof Legend.Category;
declare type ContinuousLegend = typeof Legend.Continuous;
export { CategoryLegend, ContinuousLegend };
declare type HtmlTooltip = typeof Tooltip.Html;
export { HtmlTooltip };
export { Slider };
export { Scrollbar };
