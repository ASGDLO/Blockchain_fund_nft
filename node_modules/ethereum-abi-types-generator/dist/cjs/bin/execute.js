 ...
 */
function execute(packageVersion) {
    return __awaiter(this, void 0, void 0, function () {
        var args;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    args = helpers_1.default.getProgramArguments();
                    if (args.options.v || args.options.version) {
                        return [2 /*return*/, logger_1.Logger.log(packageVersion)];
                    }
                    if (args.command === 'help' || args.options.help) {
                        // only supported command right now but written in away to extend wouldnt be too
                        // much restructing
                        return [2 /*return*/, logger_1.Logger.log(helpers_1.default.getHelpMessageByCommandType(command_types_1.CommandTypes.generate))];
                    }
                    return [4 /*yield*/, commands_1.default.generate.action(args)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
