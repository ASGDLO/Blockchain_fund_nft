...
export declare class EthersFactory {
    constructor();
    /**
     * Build ethers generic interfaces
     */
    buildEthersInterfaces(abiName: string, ethersVersion: EthersVersion): string;
    /**
     ...
     */
    buildEventInterfaceProperties(abiItems: AbiItem[]): string;
    /**
     * Build the method return context
     * @param type The type it returns
     * @param abiItem The abi item
     */
    buildMethodReturnContext(type: string, abiItem: AbiItem): string;
    /**
     ...
     */
    addOverridesToParameters(parameters: string, abiItem: AbiItem): string;
}
