 ...
 */
export function execute(packageVersion) {
    return __awaiter(this, void 0, void 0, function () {
        var args;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    args = Helpers.getProgramArguments();
                    if (args.options.v || args.options.version) {
                        return [2 /*return*/, Logger.log(packageVersion)];
                    }
                    if (args.command === 'help' || args.options.help) {
                        // only supported command right now but written in away to extend wouldnt be too
                        // much restructing
                        return [2 /*return*/, Logger.log(Helpers.getHelpMessageByCommandType(CommandTypes.generate))];
                    }
                    return [4 /*yield*/, commands.generate.action(args)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
