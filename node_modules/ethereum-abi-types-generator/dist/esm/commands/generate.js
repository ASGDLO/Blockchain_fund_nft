...
var help = Helpers.getHelpMessageByCommandType(CommandTypes.generate);
export default {
    action: function (cmd) {
        return __awaiter(this, void 0, void 0, function () {
            var language, generateResponse;
            return __generator(this, function (_a) {
                if (!cmd.command || cmd.command.length === 0) {
                    return [2 /*return*/, Logger.log(help)];
                }
                language = cmd.options.lang || ConverterType.ts;
                try {
                    switch (language) {
                        case ConverterType.ts:
                            generateResponse = new AbiGenerator({
                                provider: cmd.options.provider || Provider.web3,
                            ...
                            break;
                        default:
                            Logger.error("\"" + language + "\" is not supported. Support languages are - 'ts'");
                            return [2 /*return*/];
                    }
                }
                catch (error) {
                ...
                Logger.log("successfully created typings for abi file " + generateResponse.abiJsonFileLocation + " saved in " + generateResponse.outputLocation);
                return [2 /*return*/];
            });
        });
    },
